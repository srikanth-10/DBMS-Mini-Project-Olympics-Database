  ...
  <div class="row m-0">
    ...
    <form action="NewCountry.php" method="post" enctype="multipart/form-data" id="NewCountry-form">
      <div class="form-row my-4">
        <div class="col">
            <input type="text" maxlength="20" pattern="[A-Za-z ]{1,}" value="<?php if(isset($_POST['Country_Name'])) echo $_POST['Country_Name'];  ?>" required name="Country_Name" id="Country_Name" class="form-control" placeholder="Country's Name">
        </div>
