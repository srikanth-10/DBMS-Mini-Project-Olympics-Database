...
<section id='NewResult'>
  <div class="row m-0">
    ...
    <form action="UpdateResult.php" method="get" enctype="multipart/form-data" id="NewResult-form">
      ...
      <div class="form-row my-4">
        <div class="col">
            <input type="number" pattern="[0-9]{4}" max="9999" min="1"  value="<?php echo "$ei"?>" required name="ei" id="Event_Id" class="form-control" placeholder="Event_Id">
        </div>
      </div>

      <div class="form-row my-4">
        <div class="col">
            <input type="text" maxlength="20" value="<?php echo "$en"?>" required name="en" id="Event_Name" class="form-control" placeholder="Event Name">
      </div>
    </div>

      <div class="form-row my-4">
        <div class="col">
            <input type="number" pattern="[0-9]{4}" max="9999" min="1"  value="<?php echo "$ai"?>" required name="ai" id="Athlete_Id" class="form-control" placeholder="Athlete_Id">
        </div>
      </div>
      <div class="form-row my-4">
        <div class="col">
            <input type="text"  maxlength="6"
            pattern="Gold|Silver|Bronze|-" value="<?php echo "$mt"?>" required name="mt" id="Medal_Type" class="form-control" placeholder="Medal_Type">
        </div>
      </div>

      <div class="form-row my-4">
        <div class="col">
            <input type="number" pattern="[0-9]{8}"max="99999999" value="<?php echo "$tt"?>" required name="tt" id="Total_Time" class="form-control" placeholder="Total_Time">
        </div>
      </div>
