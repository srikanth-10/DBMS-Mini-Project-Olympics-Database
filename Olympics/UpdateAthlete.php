...
<section id='NewAthlete'>
  <div class="row m-0">
    ...
    <form action="UpdateAthlete.php" method="get">
      ...
      <div class="form-row my-4">
        <div class="col">
            <input type="text" maxlength="20" pattern="[A-Za-z .]{1,}" value="<?php echo "$an"?>" required name="an" id="Athlete_Name" class="form-control" placeholder="Athlete's Name">
        </div>
      </div>
      <div class="form-row my-4">
        <div class="col">
            <input type="text" pattern="M|F|m|f" maxlength="1"  value="<?php echo "$g"?>"required name="g" id="Gender" class="form-control" placeholder="Gender">
        </div>
      </div>
