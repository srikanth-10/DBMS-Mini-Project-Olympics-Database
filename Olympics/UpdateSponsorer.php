...
<section id='NewSponsorer'>
  <div class="row m-0">
    ...
    <form action="UpdateSponsorer.php" method="get" enctype="multipart/form-data" id="NewSponsorer-form">
      ...
      <div class="form-row my-4">
        <div class="col">
            <input type="text"  maxlength="20" pattern="[A-Za-z ]{1,}" value="<?php echo "$sn"?>" required name="sn" id="Sponsorer_Name" class="form-control" placeholder="Sponsorer's Name">
        </div>
      </div>
      <div class="form-row my-4">
        <div class="col">
        ...
        <div class="form-row my-4">
          <div class="col">
              <input type="number"  pattern="[0-9]{8}"max="99999999" value="<?php echo "$sa"?>" required name="sa" id="Sponsorship_Amount" class="form-control" placeholder="Sponsorship Amount">
          </div>
        </div>
