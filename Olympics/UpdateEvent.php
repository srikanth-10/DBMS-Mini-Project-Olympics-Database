...
<section id='NewEvent'>
  <div class="row m-0">
    ...
    <form action="UpdateEvent.php" method="get" enctype="multipart/form-data" id="NewEvent-form">
      ...
      <div class="form-row my-4">
        <div class="col">
            <input type="text" maxlength="20"  value="<?php echo "$en"?>"required name="en" id="Event_Name" class="form-control" placeholder="Events's Name">
        </div>
      </div>
      ...
      <div class="form-row my-4">
        <div class="col">
            <input type="text" pattern="T|F|t|f" maxlength="1" value="<?php echo "$et"?>"required name="et" id="Event_Type" class="form-control" placeholder="Event Type">
        </div>
      </div>

      <div class="form-row my-4">
        <div class="col">
            <input type="text" maxlength="20" pattern="[A-Za-z ]{1,}" value="<?php echo "$v"?>"required name="v" id="Venue" class="form-control" placeholder="Venue">
        </div>
      </div>
        ...
        <div class="form-row my-4">
          <div class="col">
              <input type="number" pattern="[0-9]{3}" max="999" min="1" value="<?php echo "$cc"?>"required name="cc" id="Country_Code" class="form-control" placeholder="Country Code">
          </div>
        </div>
