  ...
  <div class="row m-0">
    ...
    <form action="NewAthlete.php" method="post" enctype="multipart/form-data" id="NewAthlete-form">
      <div class="form-row my-4">
        <div class="col">
            <input type="text" maxlength="20" pattern="[A-Za-z .]{1,}"  value="<?php if(isset($_POST['Athlete_Name'])) echo $_POST['Athlete_Name'];  ?>" required name="Athlete_Name" id="Athlete_Name" class="form-control" placeholder="Athlete's Name">
        </div>
      </div>
      <div class="form-row my-4">
        <div class="col">
