...
<section id='NewEvent'>
  <div class="row m-0">
    ...
    <form action="NewEvent.php" method="post" enctype="multipart/form-data" id="NewEvent-form">
      ...
      <div class="form-row my-4">
        <div class="col">
            <input type="text" pattern="T|F|t|f" maxlength="1" value="<?php if(isset($_POST['Event_Type'])) echo $_POST['Event_Type'];  ?>" required name="Event_Type" id="Event_Type" class="form-control" placeholder="Event Type">
        </div>
      </div>

      <div class="form-row my-4">
        <div class="col">
            <input type="text" maxlength="20" pattern="[A-Za-z ]{1,}" value="<?php if(isset($_POST['Venue'])) echo $_POST['Venue'];  ?>" required name="Venue" id="Venue" class="form-control" placeholder="Venue">
        </div>
      </div>
        ...
        <div class="form-row my-4">
          <div class="col">
              <input type="number" pattern="[0-9]{3}" max="999" min="1" value="<?php if(isset($_POST['Country_Code'])) echo $_POST['Country_Code'];  ?>" required name="Country_Code" id="Country_Code" class="form-control" placeholder="Country Code">
          </div>
        </div>
